...
import { simplifyError, analyzeCompilationError } from './error-simplification';
import { 
  getBalance, 
  getAccountInfo, 
  getProgramAccounts, 
...
router.post('/ai/simplify-error', simplifyError);
router.post('/ai/analyze-compilation-error', analyzeCompilationError);
...
pub struct Withdraw<'info> {
  ...
  res.json({
    success: true,
    code: templateCode[id as keyof typeof templateCode] || 'Template not found',
    timestamp: new Date()
  });
});
